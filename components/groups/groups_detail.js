...
function GroupsDetail(props) {
  ...
  const renderedMembers = group.members.map((member) => {
    return <Text key={member.name}>{member.name}, </Text>;
  });
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Message type='self' />
        <TouchableOpacity onPress={() => setModalVisability(true)}>
        ...
        <View style={styles.modal}>
          <View style={styles.modalContent}>
            <View style={styles.modalTitle}>
              <Text style={styles.modalText}>Group Quest:</Text>
              <Text style={styles.modalNameText}>Jump in the River</Text>
            </View>
            <Text style={styles.modalDetailsText}>Description:</Text>
            <Text>Come to the river at 2 PM and jump in!!!</Text>
